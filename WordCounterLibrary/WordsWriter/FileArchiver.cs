...
namespace WordCounterLibrary.WordsWriter
{
  internal class FileArchiver : IArchiver
  {
    ...
    public FileArchiver(ILogger<FileArchiver> logger, IWordRepository wordRepository, IIOManager iOManager)
    {
    ...
    public void Archive(IIndexCards indexCards)
    {
      ...
      Parallel.ForEach(indexCards.GetIndexCards(), entry =>
      {
        ...
        File.WriteAllText(outputFile, content); //TODO: Use stream writer - write pr. line. 
